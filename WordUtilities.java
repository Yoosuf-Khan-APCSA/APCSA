...
/**
 * WordFinder - Does the following readWordsFromFile - reads words from a file
 * and puts them into the List words; the file must contain a list of random
 * words separated by spaces and/or new lines
 *
 * findWord - uses binary search to look for a word in the List words; returns
 * index of word found; returns negative number otherwise
 *
...
public class WordUtilities {
    ...
    /**
     * Uses binary search to find a word in the word List Precondition: words
     * must be sorted in ascending order
     *
     * @param word	the target word to find
     * @return	if found, the index of the word inside words; if not found, a
     * negative number
     */
    ...
    /**
     * Binary Search - find the target in the List Preconditions: listOfWords is
    ...
    /**
     * Recursive binary search - find the target word in the list between low
     * and high indices Precondition: list of words must be sorted in ascending
     * order
     *
    ...
    /**
     * Iterative binary search - find the target word in the list Precondition:
     * list of words must be sorted in ascending order
     *
     * @param listOfWords	list of words to search
     * @param target	the word to search for
     * @return	if found, the index of the word inside words; if not found, a
