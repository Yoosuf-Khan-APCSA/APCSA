...
public class Snake extends SinglyLinkedList<Coordinate> {
    ...
    /**
     * Constructor for making a Snake that is 5 grids high facing north. Places
     * the snake head at Coordinate location and the tail below. Precondition:
     * To place the Snake, the board must have at least location.getRow() + 4
     * more rows.
     */
